...
public class payment extends javax.swing.JFrame {
    ...
    private void searchBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchBtnMouseClicked
        ...
        DefaultTableModel model  =(DefaultTableModel)jTable1.getModel();
        try{
            String sqlPayment = "SELECT * FROM payment WHERE id=?";
            Connection connection = ConnectionProvider.getConnection();
            PreparedStatement paymentSt = connection.prepareStatement(sqlPayment);
            paymentSt.setString(1, id);
            ResultSet result = paymentSt.executeQuery();
...
java.time.LocalDate nextMonth = todayDate.plusMonths(1);

        String payDate = todayDate.toString();
        String dueDate = nextMonth.toString();
